...
envsubst < aurora.conf.template > aurora.conf
chmod 640 aurora.conf

echo "[OK] Config generata: $(pwd)/aurora.conf"
echo "     Installa con: sudo cp aurora.conf /etc/mosquitto/conf.d/aurora.conf"
