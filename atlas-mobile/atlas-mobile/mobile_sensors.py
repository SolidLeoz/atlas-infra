...
def load_env_file():
    candidates = []
    env_path = os.environ.get("ATLAS_ENV_FILE")
    if env_path:
...
broker_env = env_value("ATLAS_MOBILE_MQTT_BROKER_HOST")
port_env = env_value("ATLAS_MOBILE_MQTT_BROKER_PORT")
client_id_env = env_value("ATLAS_MOBILE_MQTT_CLIENT_ID")
username_env = env_value("ATLAS_MOBILE_MQTT_USERNAME")
password_env = env_value("ATLAS_MOBILE_MQTT_PASSWORD")
telemetry_topic_env = env_value("ATLAS_MOBILE_MQTT_TELEMETRY_TOPIC")
commands_topic_env = env_value("ATLAS_MOBILE_MQTT_COMMANDS_TOPIC")
battery_topic_env = env_value("ATLAS_MOBILE_MQTT_SENSORS_BATTERY_TOPIC")
location_topic_env = env_value("ATLAS_MOBILE_MQTT_SENSORS_LOCATION_TOPIC")
sensor_topic_env = env_value("ATLAS_MOBILE_MQTT_SENSORS_SENSOR_TOPIC")
interval_env = env_value("ATLAS_MOBILE_SENSORS_INTERVAL")
...
if mqtt_cfg.get("broker") is None or mqtt_cfg.get("port") is None or mqtt_cfg.get("client_id") is None:
    raise SystemExit("Missing required MQTT settings. Check ATLAS_MOBILE_* values in .env.")
...
# ----------------------------
LOCK_DIR = os.path.join(os.path.expanduser("~"), ".atlas-lock")
...
DISK_PATH = os.path.expanduser(env_value("ATLAS_MOBILE_DISK_PATH") or "~")
...
def execute_command_async(command_data: dict):
    ...
    try:
        if action == "vibrate":
            ...
            title = command_data.get("title", "Atlas")
